...
void aa(int a[2], int tabuleiro1[6][6], int tabuleiro2[6][6]); //essa é a função pra setar quantas peças cada jogador jogou
void jogo(int plataforma, int tabuleiro1[6][6], int tabuleiro2[6][6], int *jogador, int a[2], int pontos[2]);
...
void aa(int a[2], int tabuleiro1[6][6], int tabuleiro2[6][6]){
    for(int i = 0; i < 6; i++){
        for(int j = 0; j < 6; j++){
            if(tabuleiro1[i][j] == 1){
                a[0]++;
